...
const Navbar = () => {
  ...
  return (
    <div className=" nav  px-4 sm:px-6 lg-px8 mx-auto max-w-[1500px] h-[8vh] ">
      <div className="  flex items-center justify-between h-16 lg:h20 bg-[#223]/30 rounded-b-3xl shadow-lg px-4  ">
        ...
        <ul className="text-gray-700 font-medium hidden lg:flex lg:items-center lg:justify-center lg:space-x-10 text-2xl">
          ...
          <li className="p-2">
            <NavLink to="/projects" activeClassName="text-black">
              Projects
            </NavLink>
          </li>
          <li className="p-2">
